const request = require('supertest');
  ...
  describe('POST /api/admin/clear-invalid-devices', () => {
    ...
    beforeEach(async () => {
      ...
      mockXlsx.utils.write = jest.fn().mockReturnValue(Buffer.from('mocked buffer'));
    });

    it('should clear invalid devices and re-sync', async () => {
      mockDeviceFind.mockResolvedValue([
        { serialNumber: 'INVALID', osName: '', deviceInfo: 'Invalid Device' }, // Invalid device (missing osName)
